<template>
  <div>
    <b-row>
      <b-col>
        <b-alert show class="community-title text-dark"><h3>QnA</h3></b-alert>
      </b-col>
    </b-row>
    ...
    <b-container class="community-container">
      <b-row>
        ...
        <b-col>
          <b-button variant="primary" @click="getArticle()" class="notice-write-button"
            >검색</b-button
          >
        </b-col>
        <b-col class="text-right">
          ...
          <b-button variant="primary" @click="moveWrite()" class="notice-write-button"
            >QnA 작성</b-button
          >
        </b-col>
      </b-row>
      <b-row>
        <b-col>
          <b-alert show class="community-list-title"><h3>QnA 게시판</h3></b-alert>
        </b-col>
      </b-row>
...
import QuestionListRow from '@/components/question/child/QuestionListRow';
