...
public class UserController {
	...
	@PostMapping("/login")
	public ResponseEntity<Map<String, Object>> login(@RequestBody @ApiParam(value = "로그인 시 필요한 회원정보(아이디, 비밀번호).", required = true) UserDto userDto) throws Exception {
...
//				로그인 사용자 정보.
	...
	@PutMapping
	public ResponseEntity<String> modifyUser(@RequestBody @ApiParam(value = "회원 정보", required = true) UserDto userDto) throws Exception {
	...
	@DeleteMapping
	public ResponseEntity<String> deleteUser(@RequestBody @ApiParam(value = "삭제할 회원 정보 (userId만 필요)", required = false) UserDto userDto) throws Exception {
